# Interface
~~MyContract를 통해 Contact를 increment해야 되는데 그 내용이 없습니다~~
## 학습 목표
- Interface의 개념을 이해한다.
...
- Deploy 진행 후, MyContract 계약을 사용하여 Counter 계약이 잘 작동하는지 확인한다. increment 1회한 후 count를 조회한 사진이다. MyContract를 통해 interface를 활용해 잘 구현된 것을 확인할 수 있다.  <br>
   <img src="https://github.com/YoonHo-Chang/ludium-module/blob/52dd734c33d090f15351511824a0c7265685f7f5/images/mycontract_count.png" width="400px" height="500px" title="count" alt="interface">

   <img src="https://github.com/YoonHo-Chang/ludium-module/blob/52dd734c33d090f15351511824a0c7265685f7f5/images/mc_increment.png" width="400px" height="500px" title="count" alt="interface">
