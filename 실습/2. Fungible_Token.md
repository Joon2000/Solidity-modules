...
5. 승인 설정
   - 첫 번째 토큰 소유자 계정으로 첫 번째 MyToken의 approve 함수를 호출하여 TokenSwap에 10 토큰 사용 권한을 부여한다.
   - 두 번째 토큰 소유자 계정으로 두 번째 MyToken의 approve 함수를 호출하여 TokenSwap에 20 토큰 사용 권한을 부여한다.
